    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:image" content={`https://codyogden.com/images/social/${post.id}.png`} />
                ...
                <meta property="twitter:image" content={`https://codyogden.com/images/social/${post.id}.png`} />
